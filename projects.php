        ...
        <div class="welcomezone">
          <div class="welcomebottom">
            <div class="welcomeworkarea">
              <h1>Projects</h1>
              <div> <strong>Rehabilitated bridge information is taken from the Financial Management Information System. Bridge rehabilitation improvement types along with the construction authorization date are used to generate the bridge rehabilitation totals.</strong><br />
                <br />
                 </div>
            </div>
          </div>
